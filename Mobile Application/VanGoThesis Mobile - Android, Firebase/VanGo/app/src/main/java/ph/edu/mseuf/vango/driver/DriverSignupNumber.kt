...
import ph.edu.mseuf.vango.databinding.DriverSignupNumberBinding
import java.util.concurrent.TimeUnit

class DriverSignupNumber : AppCompatActivity() {

    private lateinit var binding: DriverSignupNumberBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DriverSignupNumberBinding.inflate(layoutInflater)
        ...
        mcallBacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
            ...
            override fun onVerificationFailed(e: FirebaseException) {
                ...
                Toast.makeText(this@DriverSignupNumber, "${e.message}", Toast.LENGTH_SHORT).show()
            }
            ...
            override fun onCodeSent(verificationId: String, token: PhoneAuthProvider.ForceResendingToken) {
                ...
                Toast.makeText(this@DriverSignupNumber, "Verification Code Sent", Toast.LENGTH_SHORT).show()
        ...
        binding.phoneContinueBtn.setOnClickListener {
            ...
            if (TextUtils.isEmpty(phone)){
                Toast.makeText(this@DriverSignupNumber, "Please Enter Phone Number", Toast.LENGTH_SHORT).show()
            }
            else {
        ...
        binding.codeSubmitBtn.setOnClickListener {
            ...
            if (TextUtils.isEmpty(code)){
                Toast.makeText(this@DriverSignupNumber, "Please Enter verification code", Toast.LENGTH_SHORT).show()
            }
            else {
        ...
        if (credential != null) {
            firebaseAuth.signInWithCredential(credential)
                .addOnSuccessListener {
                    ...
                    var intent = Intent(this@DriverSignupNumber, DriverAdditionalInfo::class.java)
                    intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
                    intent.putExtra("user_account", phone)
