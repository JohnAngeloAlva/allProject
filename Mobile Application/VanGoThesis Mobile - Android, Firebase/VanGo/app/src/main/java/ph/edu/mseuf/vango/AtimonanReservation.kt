...
import ph.edu.mseuf.vango.databinding.ActivityAtimonanReservationBinding


class AtimonanReservation : AppCompatActivity() {
    private lateinit var binding: ActivityAtimonanReservationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAtimonanReservationBinding.inflate(layoutInflater)
    ...
    override fun onStart() {
        ...
        database2.addListenerForSingleValueEvent(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val seat1 = snapshot.child(vanID!!).child("Seats").child("atimonanSeatA1").value
                val seat2 = snapshot.child(vanID).child("Seats").child("atimonanSeatA2").value
                val seat3 = snapshot.child(vanID).child("Seats").child("atimonanSeatA3").value
                val seat4 = snapshot.child(vanID).child("Seats").child("atimonanSeatA4").value
                val seat5 = snapshot.child(vanID).child("Seats").child("atimonanSeatB1").value
                ...
                database1.addListenerForSingleValueEvent(object : ValueEventListener{
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        else if(user == "atimonanSeatA2"){
                            btnSeat1.isEnabled = false
                            btnSeat3.isEnabled = false
                            btnSeat4.isEnabled = false
                            btnSeat5.isEnabled = false
                        }
                        else if(user == "atimonanSeatA3"){
                            btnSeat1.isEnabled = false
                            btnSeat2.isEnabled = false
                            btnSeat4.isEnabled = false
                            btnSeat5.isEnabled = false
                        }
                        else if(user == "atimonanSeatA4"){
                            btnSeat1.isEnabled = false
                            btnSeat2.isEnabled = false
                            btnSeat3.isEnabled = false
                            btnSeat5.isEnabled = false
                        }
                        else if(user == "atimonanSeatB1"){
                            btnSeat1.isEnabled = false
                            btnSeat2.isEnabled = false
                            btnSeat3.isEnabled = false
                            btnSeat4.isEnabled = false
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(user == "0"){
                    ...
                    btnAdd.setOnClickListener{
                        ...
                        startActivity(Intent(this@AtimonanReservation, CommuterHome::class.java))
                        finish()
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat1 == "Available"){
                                    ...
                                    database2.child(vanID).child("Seats").child("atimonanSeatA1").setValue("Reserved")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("atimonanSeatA1")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat1 == "Reserved"){
                                    ...
                                    database2.child(vanID).child("Seats").child("atimonanSeatA1").setValue("Available")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat2 == "Available"){
                                    ...
                                    database2.child(vanID).child("Seats").child("atimonanSeatA2").setValue("Reserved")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("atimonanSeatA2")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat2 == "Reserved"){
                                    ...
                                    database2.child(vanID).child("Seats").child("atimonanSeatA2").setValue("Available")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("0")
                                    database1.child(auth.currentUser!!.uid).child("vanID").setValue("0")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat3 == "Available"){
                                    ...
                                    database2.child(vanID).child("Seats").child("atimonanSeatA3").setValue("Reserved")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("atimonanSeatA3")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat3 == "Reserved"){
                                    ...
                                    database2.child(vanID).child("Seats").child("atimonanSeatA3").setValue("Available")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("0")
                                    database1.child(auth.currentUser!!.uid).child("vanID").setValue("0")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat4 == "Available"){
                                    ...
                                    database2.child(vanID).child("Seats").child("atimonanSeatA4").setValue("Reserved")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("atimonanSeatA4")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat4 == "Reserved"){
                                    ...
                                    database2.child(vanID).child("Seats").child("atimonanSeatA4").setValue("Available")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("0")
                                    database1.child(auth.currentUser!!.uid).child("vanID").setValue("0")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat5 == "Available"){
                                    ...
                                    database2.child(vanID).child("Seats").child("atimonanSeatB1").setValue("Reserved")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("atimonanSeatB1")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat5 == "Reserved"){
                                    ...
                                    database2.child(vanID).child("Seats").child("atimonanSeatB1").setValue("Available")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("0")
                                    database1.child(auth.currentUser!!.uid).child("vanID").setValue("0")
