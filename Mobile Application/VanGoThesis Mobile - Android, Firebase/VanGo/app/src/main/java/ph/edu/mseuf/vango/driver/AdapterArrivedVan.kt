...
class AdapterArrivedVan (private val vanArrivedList: ArrayList<SettingArrivedVan>) : RecyclerView.Adapter<AdapterArrivedVan.myViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterArrivedVan.myViewHolder {
    ...
    override fun onBindViewHolder(holder: AdapterArrivedVan.myViewHolder, position: Int) {
