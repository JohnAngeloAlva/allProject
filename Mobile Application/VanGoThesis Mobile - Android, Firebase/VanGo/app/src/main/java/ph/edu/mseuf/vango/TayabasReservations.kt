...
import ph.edu.mseuf.vango.databinding.ActivityDeleteReservationBinding
import ph.edu.mseuf.vango.databinding.ActivityTayabasReservationsBinding


class TayabasReservations : AppCompatActivity() {
    private lateinit var binding: ActivityTayabasReservationsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTayabasReservationsBinding.inflate(layoutInflater)
    ...
    override fun onStart() {
        ...
        database2.addListenerForSingleValueEvent(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val seat1 = snapshot.child(vanID).child("Seats").child("tayabasSeatA1").value
                val seat2 = snapshot.child(vanID).child("Seats").child("tayabasSeatA2").value
                val seat3 = snapshot.child(vanID).child("Seats").child("tayabasSeatA3").value
                val seat4 = snapshot.child(vanID).child("Seats").child("tayabasSeatA4").value
                val seat5 = snapshot.child(vanID).child("Seats").child("tayabasSeatB1").value
                ...
                database1.addListenerForSingleValueEvent(object : ValueEventListener{
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        else if(user == "tayabasSeatA2"){
                            btnSeat1.isClickable = false
                            btnSeat3.isClickable = false
                            btnSeat4.isClickable = false
                            btnSeat5.isClickable = false
                        }
                        else if(user == "tayabasSeatA3"){
                            btnSeat1.isClickable = false
                            btnSeat2.isClickable = false
                            btnSeat4.isClickable = false
                            btnSeat5.isClickable = false
                        }
                        else if(user == "tayabasSeatA4"){
                            btnSeat1.isClickable = false
                            btnSeat2.isClickable = false
                            btnSeat3.isClickable = false
                            btnSeat5.isClickable = false
                        }
                        else if(user == "tayabasSeatB1"){
                            btnSeat1.isClickable = false
                            btnSeat2.isClickable = false
                            btnSeat3.isClickable = false
                            btnSeat4.isClickable = false
                ...
                if(seat1 == "Reserved"){
                    btnSeat1.setBackgroundResource(R.color.yellow_500)
                }
                if(seat2 == "Reserved"){
                    btnSeat2.setBackgroundResource(R.color.yellow_500)
                }
                if(seat3 == "Reserved"){
                    btnSeat3.setBackgroundResource(R.color.yellow_500)
                }
                if(seat4 == "Reserved"){
                    btnSeat4.setBackgroundResource(R.color.yellow_500)
                }
                if(seat5 == "Reserved"){
                    btnSeat5.setBackgroundResource(R.color.yellow_500)
                }
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(user == "0"){
                    ...
                    btnAdd.setOnClickListener{
                        ...
                        startActivity(Intent(this@TayabasReservations, CommuterHome::class.java))
                        finish()
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat1 == "Available"){
                                    ...
                                    database2.child(vanID).child("Seats").child("tayabasSeatA1").setValue("Reserved")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("tayabasSeatA1")
                    ...
                    btnDelete.setOnClickListener{
                        val view = ActivityDeleteReservationBinding.inflate(layoutInflater)

                        val builder = AlertDialog.Builder(this@TayabasReservations)
                        builder.setView(view.root)
                            ...
                            val eventListener: ValueEventListener = object : ValueEventListener{
                                ...
                                override fun onDataChange(snapshot: DataSnapshot) {
                                    ...
                                    if(seat1 == "Reserved"){
                                        ...
                                        database2.child(vanID).child("Seats").child("tayabasSeatA1").setValue("Available")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat2 == "Available"){
                                    ...
                                    database2.child(vanID).child("Seats").child("tayabasSeatA2").setValue("Reserved")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("tayabasSeatA2")
                            ...
                            val eventListener: ValueEventListener = object : ValueEventListener{
                                ...
                                override fun onDataChange(snapshot: DataSnapshot) {
                                    ...
                                    if(seat2 == "Reserved"){
                                        ...
                                        database2.child(vanID).child("Seats").child("tayabasSeatA2").setValue("Available")
                                        database1.child(auth.currentUser!!.uid).child("seatID").setValue("0")
                                        database1.child(auth.currentUser!!.uid).child("vanID").setValue("0")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat3 == "Available"){
                                    ...
                                    database2.child(vanID).child("Seats").child("tayabasSeatA3").setValue("Reserved")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("tayabasSeatA3")
                            ...
                            val eventListener: ValueEventListener = object : ValueEventListener{
                                ...
                                override fun onDataChange(snapshot: DataSnapshot) {
                                    ...
                                    if(seat3 == "Reserved"){
                                        ...
                                        database2.child(vanID).child("Seats").child("tayabasSeatA3").setValue("Available")
                                        database1.child(auth.currentUser!!.uid).child("seatID").setValue("0")
                                        database1.child(auth.currentUser!!.uid).child("vanID").setValue("0")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat4 == "Available"){
                                    ...
                                    database2.child(vanID).child("Seats").child("tayabasSeatA4").setValue("Reserved")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("tayabasSeatA4")
                            ...
                            val eventListener: ValueEventListener = object : ValueEventListener{
                                ...
                                override fun onDataChange(snapshot: DataSnapshot) {
                                    ...
                                    if(seat4 == "Reserved"){
                                        ...
                                        database2.child(vanID).child("Seats").child("tayabasSeatA4").setValue("Available")
                                        database1.child(auth.currentUser!!.uid).child("seatID").setValue("0")
                                        database1.child(auth.currentUser!!.uid).child("vanID").setValue("0")
                        ...
                        val eventListener: ValueEventListener = object : ValueEventListener{
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                if(seat5 == "Available"){
                                    ...
                                    database2.child(vanID).child("Seats").child("tayabasSeatB1").setValue("Reserved")
                                    database1.child(auth.currentUser!!.uid).child("seatID").setValue("tayabasSeatB1")
                            ...
                            val eventListener: ValueEventListener = object : ValueEventListener{
                                ...
                                override fun onDataChange(snapshot: DataSnapshot) {
                                    ...
                                    if(seat5 == "Reserved"){
                                        ...
                                        database2.child(vanID).child("Seats").child("tayabasSeatB1").setValue("Available")
                                        database1.child(auth.currentUser!!.uid).child("seatID").setValue("0")
                                        database1.child(auth.currentUser!!.uid).child("vanID").setValue("0")
