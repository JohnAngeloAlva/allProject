    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mcallBacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
            ...
            override fun onVerificationFailed(e: FirebaseException) {
                ...
                Toast.makeText(this@DriverLogin, "${e.message}", Toast.LENGTH_SHORT).show()
            }
            ...
            override fun onCodeSent(verificationId: String, token: PhoneAuthProvider.ForceResendingToken) {
                ...
                Toast.makeText(this@DriverLogin, "Verification Code Sent", Toast.LENGTH_SHORT).show()
        ...
        binding.phoneContinueBtn.setOnClickListener {
            ...
            if (TextUtils.isEmpty(phone)){
                Toast.makeText(this@DriverLogin, "Please Enter Phone Number", Toast.LENGTH_SHORT).show()
            }
            else {
        ...
        binding.codeSubmitBtn.setOnClickListener {
            ...
            if (TextUtils.isEmpty(code)){
                Toast.makeText(this@DriverLogin, "Please Enter verification code", Toast.LENGTH_SHORT).show()
            }
            else {
        ...
        if (credential != null) {
            firebaseAuth.signInWithCredential(credential)
                .addOnSuccessListener {
                    ...
                    var intent = Intent(this@DriverLogin, MainActivity::class.java)
