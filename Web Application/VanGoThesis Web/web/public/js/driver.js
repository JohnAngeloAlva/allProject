...
const usersRef = dbRef.child('SmDriverProfile');
...
function userClicked(e) {
		...
		const userRef = dbRef.child('SmDriverProfile/' + userID);
...
function editButtonClicked(e) {
	...
	const userRef = dbRef.child('SmDriverProfile/' + e.target.getAttribute("userid"));
