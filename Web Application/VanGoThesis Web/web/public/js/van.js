...
const usersRef = dbRef.child('smTerminal');
...
function readUserData() {
	...
	usersRef.on("value", snap => {
		...
		snap.forEach(childSnap => {
			...
			$li.innerHTML = value.destination;
...
function userClicked(e) {
		...
		const userRef = dbRef.child('smTerminal/' + userID);
...
function deleteUserBtnClicked(e){
	...
	editUserInputsUI.forEach(function(textField) {
		...
		deletedUserObject[textField.getAttribute("data-key")] = textField.value
	});

	userRef.remove(deletedUserObject);
...
function editButtonClicked(e) {
	...
	const userRef = dbRef.child('smTerminal/' + e.target.getAttribute("userid"));
